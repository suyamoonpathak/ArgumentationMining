    ...
    for model_name, checkpoint in Config.MODELS.items():
        ...
        for fold, (train_idx, val_idx) in enumerate(skf.split(tokenized_train, tokenized_train["labels"])):
            ...
            training_args = TrainingArguments(
                ...
                save_strategy="epoch",  # Changed from "no"
            ...
            trainer = FocalLossTrainer(
                ...
                callbacks=[loss_history, EarlyStoppingCallback(early_stopping_patience=2)]  # Added early stopping
            )
            ...
            if current_f1 > best_f1_score:
                ...
                tokenizer.save_pretrained(str(best_model_dir))  # Save tokenizer too
                ...
                with open(best_model_dir / "best_fold_info.json", "w") as f:
                    json.dump({
                        ...
                        "class_weights": Config.FOCAL_PARAMS["alpha"].tolist()
                    }, f, indent=2)
