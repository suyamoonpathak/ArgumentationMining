...
def main():
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(
            ...
            # Calculate class weights dynamically for each fold
            train_labels = tokenized_train.select(train_idx)["labels"]
            ...
            model = AutoModelForSequenceClassification.from_pretrained(
                ...
                classifier_dropout=0.3  # Additional classifier dropout
            )

            # Modified Training Arguments with stronger regularization
            training_args = TrainingArguments(
                ...
                weight_decay=0.4,  # Increased L2 regularization
                max_grad_norm=0.1,  # Tighter gradient clipping
                label_smoothing_factor=0.3,  # Increased label smoothing
                fp16=False,
                report_to="none"
            )
...
DATA_DIR = SCRIPT_DIR.parent / "data"
ALL_DATA_DIR = DATA_DIR / "all"  # New directory containing all 40 files
RESULTS_DIR = SCRIPT_DIR.parent / "results_weighted"
