...
# Configuration
GRAPH_DATA_DIR = Path("./graph_data/GAUSSIAN_NOISE_graph_data_for_joint_prediction")
NUM_FOLDS = 10
SEED = 42
EPOCHS = 10
BATCH_SIZE = 4
...
def load_graph_data():
    ...
    data_list = [torch.load(f, weights_only=False) for f in all_files]

    # Set requires_grad=False for input node features
