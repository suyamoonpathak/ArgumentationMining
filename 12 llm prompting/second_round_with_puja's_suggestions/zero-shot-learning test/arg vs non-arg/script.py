...
# Configure API keys
api_keys = ['AIzaSyBkqhTWEVFlEJGjr6DxLDK_XQD1VjEwUhM','AIzaSyCrQYcNJnJct1FRNXfo5nxv5AgFkeYr9Xk', 'AIzaSyBa5ABeuSi_Zc8RjZ4UEryl9r8B38_MwPU']
...
def get_argumentative_prediction(text):
    ...
    try:
        prompt = f"""
            You are a Harvard-trained legal expert specialized in legal argumentation analysis, with deep expertise in distinguishing "argumentative" from "non-argumentative" text in legal case files.

            Your analysis is very important. Your answer will be used in a legal research tool for senior judges working on high-impact cases. A wrong answer could cause legal mistakes, unfair judgments, or even wrongful convictions. So be very careful and precise.

            TASK:
            Read the sentence and decide if it is argumentative or non-argumentative.
            ...
            EXAMPLES OF POSSIBLE ARGUMENTATIVE SIGNALS (just examples, not all):
            1. Causal words: therefore, thus, hence, consequently, moreover, furthermore, similarly, likewise, accordingly, thereby.
            2. Opinion nouns: opinion, belief, judgment, assessment, position, argument, claim, conclusion, clarification.
            3. Reasoning verbs (any form): argue, contend, assert, conclude, assess, believe, maintain, submit, show, prove, demonstrate, justify, indicate, clarify, hold, opine.
            4. Positive/negative judgment words:
            - Negative: unfair, wrong, incorrect, inaccurate, invalid, illogical, flawed, unfounded, illegal, inconsistent, unwarranted.
            - Positive: correct, accurate, valid, logical, justified, fair, legal, appropriate, maintainable.
            5. Judgment adverbs:
            - Negative: unfairly, incorrectly, wrongly, mistakenly, illegally, inappropriately.
            - Positive: fairly, correctly, legally, appropriately.

            EXAMPLES OF NON-ARGUMENTATIVE SIGNALS:
            ...
            - Only give your final answer as one word in lowercase:
                "argumentative"
                or
                "non-argumentative"
