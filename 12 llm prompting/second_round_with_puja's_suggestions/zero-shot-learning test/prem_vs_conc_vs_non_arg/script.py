...
def get_three_way_prediction(text):
    ...
    try:
        prompt = f"""
You are an expert in legal argument analysis. Your task is to read the sentence below and decide if it is a "premise", a "conclusion", or "non-argumentative".

This is very important. Your answer will help judges make fair decisions on serious legal cases. If you choose incorrectly, it could cause mistakes in the law or unfair outcomes.
...
- Only respond with one word in lowercase:
    premise
    conclusion
    non-argumentative
