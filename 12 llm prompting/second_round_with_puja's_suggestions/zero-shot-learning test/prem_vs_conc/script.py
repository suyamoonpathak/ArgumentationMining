...
# Configure API keys
api_keys = ['AIzaSyBkqhTWEVFlEJGjr6DxLDK_XQD1VjEwUhM','AIzaSyCrQYcNJnJct1FRNXfo5nxv5AgFkeYr9Xk', 'AIzaSyBa5ABeuSi_Zc8RjZ4UEryl9r8B38_MwPU','AIzaSyAhna31nA7OwXC7H3UBBbmrw3HqtLGS3ok','AIzaSyAlepfveNi6PV1PMuxPJ_4M-qmowFP18SU', 'AIzaSyCTvL8JQDbFxqhmptoBf22sy4VsL7qK8hc','AIzaSyC8J9JSMCoCpGUnQYYBAhep3aS90d_NbVw', 'AIzaSyC1HXjY8xv-YnKrnZBDk4775NbbRLYepPA', 'AIzaSyBhsULUFDO2MQFV4xw1jQvWaIoKBvDf6vo','AIzaSyD4islRmk3UUTdAN5q9XI5mITr6H75b1gM'
]
...
def get_premise_conclusion_prediction(text):
    ...
    try:
        prompt = f"""
            You are an expert in legal argument analysis. Your task is to read the given legal sentence and decide if it is a "premise" or a "conclusion" in a legal argument.
