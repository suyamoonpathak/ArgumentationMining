...
# Configuration
INPUT_DATA_DIR = Path("./updated_echr_events/prem_vs_conc_ucreat_events_echr")
MODEL_PATH = Path("../14 events/DATA5/2 prem_vs_conc results/results_prem_vs_conc_with_events_updated/RoBERTa/best_model")
OUTPUT_DIR = Path("./predictions/prem_vs_conc_updated_events_echr/RoBERTa")
BATCH_SIZE = 8
