...
# Configuration
INPUT_DATA_DIR = Path("./ucreat_echr_events/p_c_na_ucreat_events_echr")
MODEL_PATH = Path("../14 events/DATA5/7 ucreat events/suyamoon_tmp/7 ucreat events remaining/Results/results_p_c_na_with_ucreat_events/RoBERTa/best_model")
OUTPUT_DIR = Path("./predictions/p_c_na_ucreat_events_echr/RoBERTa")
BATCH_SIZE = 8
