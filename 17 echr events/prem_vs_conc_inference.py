...
# Configuration
INPUT_DATA_DIR = Path("./ucreat_echr_events/prem_vs_conc_ucreat_events_echr")
MODEL_PATH = Path("../14 events/DATA5/7 ucreat events/suyamoon_tmp/7 ucreat events remaining/Results/results_prem_vs_conc_with_ucreat_events/RoBERTa/best_model")
OUTPUT_DIR = Path("./predictions/prem_vs_conc_ucreat_events_echr/RoBERTa")
BATCH_SIZE = 8
...
def process_single_file(file_path, model, tokenizer):
    ...
    try:
        ...
        df['prob_conclusion'] = probabilities[:, 0]  # Probability for class 0 (Conclusion)
        ...
        label_mapping = {0: 'Conclusion', 1: 'Premise'}
...
def main():
    ...
    # Summary
    print(f"\n{'='*50}")
    print("PREMISE VS CONCLUSION INFERENCE SUMMARY")
    print(f"{'='*50}")
    ...
    if successful_predictions > 0:
        ...
        print("- predictions: Numerical predictions (0: Conclusion, 1: Premise)")
