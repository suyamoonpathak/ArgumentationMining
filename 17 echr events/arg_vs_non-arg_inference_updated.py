...
# Configuration
INPUT_DATA_DIR = Path("./updated_echr_events/arg_vs_non-arg_ucreat_events_echr")
MODEL_PATH = Path("../14 events/DATA5/1 arg_vs_non-arg results/results_arg_vs_non-arg_with_events_updated/RoBERTa/best_model")
OUTPUT_DIR = Path("./predictions/arg_vs_non-arg_updated_events_echr/RoBERTa")
BATCH_SIZE = 8
