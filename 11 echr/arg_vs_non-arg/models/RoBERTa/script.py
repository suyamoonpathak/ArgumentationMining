...
MODEL_PATH = "./checkpoint-4056"  # Relative path from script.py location
DATA_PATH = "../../data"  # Path to data folder
RESULTS_PATH = "./results_checkpoint"  # Where to save results
...
def load_test_data(data_path):
    ...
    # Create mapping: typically 'argumentative' -> 1, 'non-argumentative' -> 0
    if 'argumentative' in unique_labels and 'non-argumentative' in unique_labels:
        label_mapping = {'non-argumentative': 0, 'argumentative': 1}
    else:
